...
#define LWS_LIBRARY_VERSION_PATCH_ELABORATED 99-v4.3.0-434-ge0c312c2
...
#define LWS_BUILD_HASH "v4.3.0-434-ge0c312c2"
...
#define LWS_LIBRARY_VERSION "4.3.99-v4.3.0-434-ge0c312c2"
